# Overview of StockTTK declarative agent with API plugin template
...
> - We're using the API from [Twelvedata](https://support.twelvedata.com/en/articles/5214728-getting-historical-data), so you need to generate a free key and insert it in the instruction.txt file (instead of 'demo'). If you're using the demo key, you'll be limited to [Trial symbols](https://support.twelvedata.com/en/articles/5335783-trial)
